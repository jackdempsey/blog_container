...
require 'pancake'
require ::File.join(::File.expand_path(::File.dirname(__FILE__)), "blog_container")
...
app = Pancake.start(:root => Pancake.get_root(__FILE__)){ BlogContainer.stackup(:master => true) }
